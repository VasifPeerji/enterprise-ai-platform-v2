...
export const systems = [
  ...
  },
  {
    ...
    items: [
      ...
      { slug: 'citation', badge: '9', nav: 'Citation & Highlighting', title: 'Citation Packaging & Highlighting', tagline: 'Exact highlighted spans on the rendered page', status: 'ready', flagship: true },
    ],
  },
]
